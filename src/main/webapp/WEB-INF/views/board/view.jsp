...
<body>
 ...
 -->
	...
	<div style="float:right; display: inline-block;">
		<a href="/portfolio/board/listPageSearch?num=1" class="btn blue">게시물 목록</a> 
		<a href="/portfolio/board/modify?bno=${view.bno}" class="btn blue">게시물 수정</a> 
		<a href="javascript:pwInput()" class="btn red">게시물 삭제</a>
	</div>
	</div>
	<script>
	function pwInput(){
		...
		if (input == password) {
			...
			location.href="/portfolio/board/delete?bno=${view.bno}"
		}
		else {
			...
			<li >
				<div style="border-bottom: 1px solid gray;">
					<p style="padding-left: 10px;"><span style="font-weight: 800">${reply.writer}</span>
						...
						<a href="/portfolio/reply/update?rno=${reply.rno}&bno=${reply.bno}" class="reply-btn"> 수정</a> 
					...
					function replyDel(){
						...
						if (input == replypassword) {
							...
							location.href="/portfolio/reply/delete?rno=${reply.rno}&bno=${reply.bno}"
						}
						else {
							alert("비밀번호가 일치하지 않습니다.");
	...
	<div> 
		...
		<form method="post" action="/portfolio/reply/write" id="replyfrm" style="display: inline-block; margin-top: 4px; width: 100%; padding-left: 10px;">
